...
namespace Dig.Tests.DataAccess
{
	public class TestData
	{
		...
		{
            //new Location {CreatedByUserId = 1, CreatedDate = new DateTime(2013,1,1), ModifiedByUserId = 2, ModifiedDate = new DateTime(2013,1,2), Name = "Flannagan's Dublin", NickName = "Flans"},
			...
			new Location {CreatedByUserId = 1, CreatedDate = new DateTime(2013,1,1), Name = "default constructor", NickName = "default"}
